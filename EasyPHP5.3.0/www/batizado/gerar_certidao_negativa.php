...
<form method="post" action="gerar_certidao_negativa.php">
      ...
      <table border="0" cellpadding="1" cellspacing="0" bgcolor="000000">
             ...
             <tr>
			     ...
			     <option value="NAO SABE">NAO SABE</option>
...
?>
     ...
     <b>Caninde, <?php echo "$dia_atual de $mes_nome[$mes_numero_atual] de $ano_atual"; ?></b><br><br><br>
     ...
     <tr>
     <td align="left">
     Compareceram a minha presença <b><?php echo $_POST["testemunha1"];?></b><br>
