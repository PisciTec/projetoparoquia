...
if (isset($_POST["cadastro"]) and $_POST["cadastro"]) {
   ...
   $inserir = "insert into comunidade_saida (cod_comunidade, data_saida, valor) values ('$cod_comunidade', '$data_saida', '$valor')";
   mysql_query($inserir) or die ("Não foi possível inserir dados de saida de valor");
   echo "
       <script language=\"JavaScript\">
...
if (isset($_GET["acao"]) and $_GET["acao"] == "excluir") {
      ...
      $valor = $_GET["valor"];
      $excluir = "delete from comunidade_saida where cod_saida = '$cod_saida'";
...
<table border="0" cellpadding="1" cellspacing="1" class="table_formatada" width="700" height="600">
       ...
       <tr>
           <td bgcolor="#ffffff" height="500" valign="top">
               ...
               <form method="post" action="saida_valores.php">
                     ...
                     <br>
                     <label>Data:</label>
                     <input type="text" name="data_saida" value="<?php echo date("d/m/Y"); ?>" size="13" maxlenght="10" class="campos" tipo="numerico" mascara="##/##/####">
                     <br>
                     <label>Valor:</label>
               ...
               <center>
               <h3>Últimas Saídas de Valores</h3>
               <div id="scroll_menor">
                    ...
                    <?php
                         $consulta = "select * from comunidade_saida a inner join comunidade b where a.cod_comunidade = b.cod_comunidade order by b.nome_comunidade asc";
                               ...
                               echo "
                                    <tr>
                                        ...
                                        <td bgcolor=\"#ffffff\" align=\"center\">
                                              <input type=\"image\" src=\"images/editar.jpg\" alt=\"Editar\" value=\"Editar\" onclick=\"window.location.href='alterar_dados_saida_valor.php?cod_saida=$linha[cod_saida]';\">
                                              <input type=\"image\" src=\"images/excluir.jpg\" alt=\"Excluir\" value=\"Excluir\" onclick=\"if (confirm('Tem certeza que deseja excluir a entrada de valor')){ window.location.href='saida_valores.php?cod_saida=$linha[cod_saida]&cod_comunidade=$linha[cod_comunidade]&valor=$linha[valor]&acao=excluir'; }\">
                                        </td>
                               ";
                         }
                    ?>
