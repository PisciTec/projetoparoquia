<?php
    ...
    <html>
      ...
      if (isset($_POST["alterar"]) and ($_POST["alterar"])) {
           ...
           $atualiza = "update casamen set caslivro='$caslivro', casfolha='$casfolha', casdata='$casdata', caslocal='$caslocal', casnomee='$casnomee', casnactoe='$casnactoe', caspaie='$caspaie', casmaee='$casmaee', casviue='$casviue', casfale='$casfale', casloce='$casloce', casende='$casende', casnomea='$casnomea', casnactoa='$casnactoa', caspaia='$caspaia', casmaea='$casmaea', casviua='$casviua', casfala='$casfala', casloca='$casloca', casenda='$casenda', casdisp='$casdisp', castest1='$castest1', castest2='$castest2', casparoco='$casparoco', casobs='$casobs', casnumero='$casnumero' where codcasamento = '$codcasamento'";
