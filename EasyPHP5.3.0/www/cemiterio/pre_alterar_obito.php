<?php
    ...
    if ($_GET["acao"] == "excluir") {
          ...
          $query = "delete from cemiterio_obitos where cod_obito = '$cod_obito'";
          mysql_query($query, $conectar) or die ("Não foi possivel excluir dados do óbito!");
          echo "
    ...
    <tr>
        <td height=\"309\" align=\"center\" valign=\"top\">
            <h3>Tela de Alteração de Dados de Óbito</h3>
            <br>
            <form method=\"post\" action=\"pre_alterar_obito.php\" name=\"f1\" onsubmit=\"return validaFormulario(this);\">
          ...
          while ($linha = mysql_fetch_array($resposta)) {
                  ...
                  <tr>
                      ...
                      <td bgcolor=\"#ffffff\" align=\"center\">
                          <a href=\"alterar_dados_obito.php?cod_obito=$cod_obito\" target=\"_self\" title=\"Clique aqui para alterar dados do óbito\"><img src=\"img/icn_editar.gif\" width=\"16\" height=\"14\" border=\"0\"></a>
                          &nbsp;&nbsp;&nbsp;
                          <input type=\"button\" value=\"Excluir\" class=\"botao_ok\" onclick=\"if (confirm('Tem certeza que deseja excluir?')){ window.location.href='pre_alterar_obito.php?acao=excluir&cod_obito=$cod_obito';}\">
                          &nbsp;&nbsp;&nbsp;
                      </td>
                  </tr>
                  ";
