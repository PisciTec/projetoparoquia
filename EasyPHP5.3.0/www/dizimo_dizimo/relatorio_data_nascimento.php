<?php
    ...
    echo"
            ...
            <body>
            <h3>Relatório Dizimistas por Data de Nascimento</h3>
            <br>
    ";
        $nascto = $_GET["data"];
        $consulta = "select codigo, nome, mae, nascto, endereco from dizimo where (nascto like '$nascto') and (motivo = '1') order by nome asc";
