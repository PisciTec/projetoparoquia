...
<br>
DIZIMO É... ALEGRIA, BÊNÇÃO, GRATIDÃO, VIDA, PARTILHA, FÉ, UNIÃO, AMOR, SABEDORIA. .<br><br>
<b>Últimas contribuições</b><br>
<table border="0" cellpadding="0" cellspacing="1" bgcolor="#000000" width="740">
<?php
$codigo = $_POST["codigo"];
$i=0;
$consulta_pagamento = "select A.ANO, A.MES, A.VALOR, A.DATA from contrib A inner join dizimo B where A.CODIGO = B.CODIGO and B.CODIGO = $codigo order by A.DATA desc limit 0, 12";
