<?php
    ...
    if (isset($_POST[cadastro])) {
          ...
          if ($num == 0){
             $insert = "insert into contrib (CODIGO, ANO, MES, VALOR, DATA) values ('$codigo','$ano','$mes','$valor','$data')";
                ...
                <table width=\"600\" height=\"400\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">
                       ...
                       <tr>
                           <td valign=\"top\" align=\"center\">
                               ...
                               $consulta_pagamento = "select ANO, MES, A.VALOR, DATA from contrib A inner join dizimo B where A.CODIGO = B.CODIGO and B.CODIGO = $codigo order by A.DATA desc limit 10";
