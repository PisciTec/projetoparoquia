...
$consulta = "select codcliente, nome, endereco, ciddes, ciduf, cep, bairro from jornal_cliente inner join jornal_cidade where ativo='1' and (jornal_cliente.cidade = jornal_cidade.cidcod) order by nome asc";
