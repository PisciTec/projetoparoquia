				...
				$casidadea = $linha["CASIDADEA"];
                               ...
                               echo "
                                    <span style=\"font: arial,verdana, tahoma; font-size: 15;\">
                                     ...
                                     Ele, 
				     ";
				     if ($linha["CASNACTOE"] == "" or $ano2 == "0000"){
				     echo "com <b>$casidadee</b> anos de idade, filho de <b>$caspaie</b><br>";
				     }
				     else {	
				     echo "nascido a <b>$dia2</b> de <b>$mes[$mes_numero2]</b> de <b>$ano2</b>, filho de <b>$caspaie</b><br>";
                                     }
				     echo "
				     e de <b>$casmaee</b> natural de <b>$casloce</b><br>
                                     ...
                                     Ela, 
				     ";
				     if ($linha["CASNACTOA"] == "" or $ano3 == "0000"){
				     echo "com <b>$casidadea</b> anos de idade, filha de <b>$caspaia</b><br>";
				     }
				     else {	
				     echo "nascida a <b>$dia3</b> de <b>$mes[$mes_numero3]</b> de <b>$ano3</b>, filha de <b>$caspaia</b><br>";
                                     }
				     echo "				     
