<?php
    ...
    if (isset($_POST[cadastro])) {
       ...
       $cadastrar = "insert into casamen (caslivro, casfolha, casdata, caslocal, casnomee, 
		...
		casdisp, castest1, castest2, casparoco, casobs, casnumero, casidadee, casidadea) values
            ...
            <form method=\"post\" action=\"cadastra_casamento.php\" name=\"form_cadastro\" onsubmit=\"return validaFormulario(this);\">
                  <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"tabela_formatada\">
                         ...
                         <tr>
                             ...
                             <td class=\"td2\">
                                 <input type=\"text\" name=\"casidadee\" value=\"\" size=\"5\" maxlength=\"5\" class=\"field_textbox\">
                         ...
                         <tr>
                             ...
                             <td class=\"td2\">
                                 <input type=\"text\" name=\"casidadea\" value=\"\" size=\"5\" maxlength=\"5\" class=\"field_textbox\">
                                 * Obs: Campo usado apenas para cadastros antigos
                             </td>
                         </tr>
