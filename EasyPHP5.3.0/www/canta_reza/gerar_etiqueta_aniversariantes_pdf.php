...
$consulta = "select codigo, nome, endereco, bairro, cidade, estado, cep from canta_reza_pessoa where motivo = '1' and (nascto like '____-$_GET[mes]-__') order by nome asc";
