<?php
    ...
    if (isset($_GET["acao"]) and $_GET["acao"]== "deletar"){
       $deletar="delete from canta_reza_pagamento where cod_contrib='$_GET[cod_contrib]'";
    ...
    echo"
            ...
            <br>
                                     ...
                                     ";
                                              $codigo = $_GET["codigo"];
                                              $consulta_pagamento = "select A.cod_contrib, A.ANO, A.MES, A.VALOR, A.DATA from canta_reza_pagamento A inner join canta_reza_pessoa B where A.CODIGO = B.CODIGO and B.CODIGO = $codigo order by A.DATA desc";
