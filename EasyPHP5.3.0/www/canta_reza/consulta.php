<?php
    ...
    <tr>
        <td height=\"309\" align=\"center\" valign=\"top\">
            ...
            <div id=\"navegacao\">
                 <ul>
                     <li><a href=\"consulta_pessoas.php\" title=\"Clique aqui para consultar todas as pessoas cadastradas!\">Total de Cadastrados</a></li>
     ...
     if (isset($_POST["alterar"])) {
        $nome = $_POST["nome"];
        $consulta = "select codigo, nome, mae from canta_reza_pessoa where nome like '%$nome%' and motivo = '1'";
          ...
          while ($linha = mysql_fetch_array($resposta)) {
                  ...
                  <tr>
                      ...
                      <td bgcolor=\"#ffffff\" align=\"center\">
                          ...
                          <a href=\"documento_pagamento.php?codigo=$codigo&nome=$nome\" target=\"_blank\" class=\"a1\">Documento Dízimo</a>
                      </td>
                  </tr>
                  ";
          }
