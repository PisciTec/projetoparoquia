<?php
    ...
    ";
        $mes = $_GET[mes];
        $consulta = "select codigo, nome, mae, nascto, dia, endereco from canta_reza_pessoa where (nascto like '$mes') and (motivo = '1') order by dia asc";
        ...
        <table border=\"0\" cellpadding=\"0\" cellspacing=\"1\" width=\"700\" class=\"tabela_formatada\">
              <tr>
                  ...
                  <td class=\"td3\"><b>Data Nascimento</b></td>
